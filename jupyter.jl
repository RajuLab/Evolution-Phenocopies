...
set_theme!(theme_minimal(),
    ...
    Axis=(
        xticklabelsize=4 / 3 * 10 * 2, xlabelsize=4 / 3 * 12 * 2,
        yticklabelsize=4 / 3 * 10 * 2, ylabelsize=4 / 3 * 12 * 2,
    ),
    Axis3=(
        xticklabelsize=4 / 3 * 12 * 2, xlabelsize=4 / 3 * 12 * 2,
        yticklabelsize=4 / 3 * 12 * 2, ylabelsize=4 / 3 * 12 * 2,
        zticklabelsize=4 / 3 * 12 * 2, zlabelsize=4 / 3 * 12 * 2,
    ),
)
